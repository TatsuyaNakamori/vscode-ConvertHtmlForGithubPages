.. Convert to GitHub Pages documentation master file, created by
   sphinx-quickstart on Sat Jun 26 22:46:10 2021.


Welcome to Convert to GitHub Pages's documentation!
===================================================

| This document is available in English and Japanese.
| このドキュメントは英語と日本語が用意されています。

| Please start from the "Overview" link below.
| 下記のリンクの「概要」からスタートしてください。
